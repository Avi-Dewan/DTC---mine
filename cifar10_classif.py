...
if __name__ == "__main__":
    ...
    train_loader = CIFAR10Loader(root=args.dataset_root, batch_size=args.batch_size, split='train',labeled = True, aug='once', shuffle=True)
    eva_loader = CIFAR10Loader(root=args.dataset_root, batch_size=args.batch_size, split='test', labeled = True, aug=None, shuffle=False)
